#Creating a Dashboard using Dash by Plotly
...
#Importing and cleaning the data from csv into pandas
df = pd.read_csv(r"C:\Users\SHREYA GUPTA\Desktop\data_sample.csv")
